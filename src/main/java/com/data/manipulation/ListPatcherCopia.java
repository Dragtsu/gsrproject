...
public class ListPatcherCopia extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       /* System.out.println("iDisplayStart.. " + request.getParameter("iDisplayStart"));
        ...
        if (tablaConsultar.equals(TRABAJADOR)) {
            ...
            enviaJsonServerSide(response, getTrabajadoresJson(
    ...
    private JSONObject getTrabajadoresJson(int iDisplayStart, int iDisplayLength, String like , String tablaConsultar) {
System.out.println("LIKE.. " + like);
        ...
        for (int i = iDisplayStart; i < limit; i++) {
            array.put(Arrays.asList((TbTrabajador.class.cast(tb.get(i))).toArray()));
        }
